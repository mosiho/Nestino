    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
      ...
      <div className="order-1 lg:order-2">
        ...
        <a
          ...
          className="flex items-center gap-3 p-4 rounded-xl border border-[var(--accent-400)]/30 bg-[var(--accent-muted)] mb-6 transition-colors duration-200 hover:border-[var(--accent-400)] active:scale-[0.98]"
        >
          <div className="flex items-center justify-center w-10 h-10 rounded-full bg-[var(--accent-500)] text-white shrink-0">
