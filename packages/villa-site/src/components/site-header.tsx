    ...
    <>
      ...
      >
        <div className="content-wrapper flex items-center justify-between h-14 md:h-16">
          ...
          {/* Desktop nav — white frosted glass */}
          <nav
            className="hidden md:flex items-center gap-7 rounded-full border border-white/55 bg-white/72 px-6 py-2 shadow-[0_4px_24px_rgba(0,0,0,0.06)] backdrop-blur-xl backdrop-saturate-150"
